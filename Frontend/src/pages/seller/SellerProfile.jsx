    ...
    const handleSave = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                setIsEditing(false);
                // Sync with global auth state (sidebar)
        ...
        <div className="min-h-screen bg-background font-sans flex overflow-x-hidden">
                            ...
                            <section className="bg-background-alt border border-border rounded-xl p-5">
                                ...
                                <div className="space-y-3">
                                    <button
                                        ...
                                        className="w-full flex items-center justify-between p-3 bg-background rounded-lg hover:bg-primary/5 transition-colors cursor-pointer group"
                                    >
            ...
            {showPasswordModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-background border border-border rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
                        <div className="p-4 border-b border-border flex justify-between items-center bg-background-alt">
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 bg-background border border-border rounded-lg focus:outline-none focus:border-primary text-text-primary"
                        ...
                        <div className="p-4 border-t border-border bg-background-alt flex justify-end gap-3">
                            <button
                                onClick={() => setShowPasswordModal(false)}
                                className="px-4 py-2 border border-border text-text-secondary text-sm font-medium rounded-lg hover:bg-background transition-colors"
                            >
                                Cancel
                            </button>
                            <button
