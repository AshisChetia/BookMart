                        ...
                        <>
                            ...
                            <section className="mb-10">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
                                    ...
                                    {suggestedBooks[0] && (
                                        <Link to={`/buyer/book/${suggestedBooks[0]?._id}`} state={{ from: 'suggested' }} className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border border-primary/10 p-6 group cursor-pointer">
                                            <div className="flex gap-5 h-full">
                                                <div className="w-36 flex-shrink-0">
                                                    <div className="relative h-52 rounded-xl overflow-hidden shadow-lg group-hover:shadow-xl transition-shadow">
                                                        <img
                                                            src={getBookImage(suggestedBooks[0])}
                                                ...
                                                <div className="flex flex-col justify-center">
                                                    ...
                                                    <div className="flex items-baseline gap-2 mt-4">
                                                        <span className="text-2xl font-bold text-text-primary">₹{suggestedBooks[0]?.price}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </Link>
